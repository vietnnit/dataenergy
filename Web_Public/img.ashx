...
public class ImageHandler : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        else
        {
            ...
            {
               // if (System.IO.File.Exists((appPath + Path.GetDirectoryName(context.Request.QueryString["url"]) + GetString(Path.GetFileNameWithoutExtension(context.Request.QueryString["url"])) + Path.GetExtension(context.Request.QueryString["url"]))))
           ...
           // string strRealname = GetString(Path.GetFileNameWithoutExtension(appPath));
