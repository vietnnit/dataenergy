<%@ control language="C#" autoeventwireup="true" CodeFile="EduList.ascx.cs" inherits="Client_EduList" %>
    ...
    <div class="row box-white mb10  mln mrn">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <ul class="list-unstyled list-inline blog-info">
                <li><i class="fa fa-calendar"></i> <asp:Label ID="lblAproved" runat="server" /></li>
                <li><i class="fa fa-pencil"></i> <asp:Label ID="LabelAuthor" runat="server" /></li>
            </ul>
        ...
        <div class="row box-white mb10 mln mrn pb10">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="media">
                    ...
                    <h3><%= Resources.resource.T_relation %></h3>
                    ...
                    <div class="media-body">
                        <ul class="paging-relation list-unstyled save-job">
                            <asp:Repeater ID="rptListNewsOther" runat="server">
                                <ItemTemplate>
                                    <li class="pt5">
                                        <i class="fa fa-caret-right color-blue"></i>
