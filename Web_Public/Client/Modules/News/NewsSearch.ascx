<%@ Control Language="C#" AutoEventWireup="true" CodeFile="NewsSearch.ascx.cs" Inherits="Client_NewsSearch" %>
...
<div class="row box-white mb10 mln mrn" id="box_paging" runat="server">
     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
