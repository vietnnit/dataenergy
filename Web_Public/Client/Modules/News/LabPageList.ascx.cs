...
using ETO;
using BSO;
public partial class Client_Modules_News_LabPageList : System.Web.UI.UserControl
{
    ...
    private void GetCateParentNewsGroup(int cId, int gId)
    {
        ...
        DataTable newsGroupPaging2 = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, Convert.ToInt32(hddGroupCate.Value), strCate, _page, 1, 1);
