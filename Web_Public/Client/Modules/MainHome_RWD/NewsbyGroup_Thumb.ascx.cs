...
using ETO;
using BSO;
public partial class Client_NewsbyGroup_Thumb : System.Web.UI.UserControl
{
    ...
    void GetNewsGroup(int groupcate)
    {
        ...
        if (AspNetCache.CheckCache("HTML_ltlNews_MainHome_by_group_list_" + hddValue.Value + "_" + Language.language.Replace("-", "_")) == false)
        {
            ...
            AspNetCache.SetCacheWithTime("HTML_ltlNews_MainHome_by_group_list_" + hddValue.Value + "_" + Language.language.Replace("-", "_"), table, 150);


        }
        else
        {
            table = (DataTable)AspNetCache.GetCache("HTML_ltlNews_MainHome_by_group_list_" + hddValue.Value + "_" + Language.language.Replace("-", "_"));
        }
