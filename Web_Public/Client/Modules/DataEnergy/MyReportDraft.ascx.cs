...
public partial class Client_Modules_DataEnergy_MyReportDraft : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        if (memVal.OrgId > 0)
        {
            DataTable list = new ReportFuelService().FindList(false, 0, 0, 0, (Convert.ToInt32(memVal.OrgId)), 0, 0, 0, null, 0, null, null, "", paging);
