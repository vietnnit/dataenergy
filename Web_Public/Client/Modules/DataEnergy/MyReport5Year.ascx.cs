...
public partial class Client_Modules_DataEnergy_MyReport5Year : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        if (memVal.OrgId > 0)
        {
            ...
            DataTable list = new ReportFuelService().FindListWithType(false, 0, 0, 0, memVal.OrgId, 0, 0, -1, false, 0, null, null, "", paging, ReportKey.PLAN5);
    ...
    private void BindDataApproved()
    {
        ...
        if (memVal.OrgId > 0)
        {
            ...
            DataTable list = new ReportFuelService().FindListWithType(false, 0, 0, 0, memVal.OrgId, 0, 0, -1, true, 0, null, null, "", paging, ReportKey.PLAN5);
    ...
    protected void btnAddReport_Click(object sender, EventArgs e)
    {
        ...
        if (memVal.OrgId > 0)
        {
            ...
            int iReportNo = reportService.CheckReportWithType(ReportYear, memVal.OrgId, ReportKey.PLAN5);
            if (iReportNo > 0)
            {
            ...
            else
            {
                ...
                if (enter != null)
                {
                    ...
                    report.ReportType = ReportKey.PLAN5;
                    if (enter != null)
                    {
    ...
    protected void rptReport_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
        {
            ...
            else
            {
                ...
                {
                    btnDelete.Visible = false;
                    ltEdit.Text = "<a href='" + ResolveUrl("~") + "bao-cao-so-lieu-5-nam-" + item["Id"] + ".aspx'><i class='fa fa-search'></i></a>";
                }
                else
                {
                    if (iStatus == 0)
                    {
                        ...
                        ltEdit.Text = "<a href='" + ResolveUrl("~") + "bao-cao-so-lieu-5-nam-" + item["Id"] + ".aspx'><i class='fa fa-edit'></i></a>";
                    }
                    else
                    {
                        btnDelete.Visible = false;
