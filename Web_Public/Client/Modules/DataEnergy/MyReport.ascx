<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MyReport.ascx.cs" Inherits="Client_Modules_DataEnergy_MyReport" %>
            ...
            <asp:Repeater ID="rptReport" runat="server" OnItemDataBound="rptReport_ItemDataBound"
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <a href='<%#ResolveUrl("~") %>bao-cao-so-lieu-hang-nam-r<%#Eval("Id")%>.aspx'>
                                <%#Eval("Year") %>
                            </a>
                        </td>
                        <td>
