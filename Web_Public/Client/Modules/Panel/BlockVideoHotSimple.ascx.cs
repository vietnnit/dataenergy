...
using ETO;
using BSO;
public partial class Client_BlockVideoHotSimple : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            ViewVideo();
            string strTitle = "<a href='" + ResolveUrl("~/") + "thu-vien-video.aspx' title='" + Resources.resource.T_Video + "'>" + Resources.resource.T_Video + "</a>";
