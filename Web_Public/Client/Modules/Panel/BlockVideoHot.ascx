<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BlockVideoHot.ascx.cs"
    Inherits="Client_BlockVideoHot" %>
<div class="r-ro">
    <div class="box-news">
                    ...
                    <asp:Repeater ID="rptVideo" runat="server">
                        <ItemTemplate>
                            <div class="item-panel-video">
                                <a class="lnk_img lnk_video" href="<%# ResolveUrl("~/") + "thu-vien-videos/"+ GetString(Eval("Title"))+Eval("VideosID") %>" title="<%# Eval("Title") %>">
                                    ...
                                    href="<%# ResolveUrl("~/") + "thu-vien-videos/"+ GetString(Eval("Title"))+Eval("VideosID") %>" title="<%# Eval("Title") %>">
