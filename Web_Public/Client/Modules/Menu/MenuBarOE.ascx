<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuBarOE.ascx.cs" Inherits="Client_Modules_Menu_MenuBarOE" %>

<div class="collapse navbar-collapse navbar-responsive-collapse">
    <div class="container">
        <asp:Literal ID="ltlMenuBarOE" runat="server"></asp:Literal>
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-submenu active">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="active"><a href="feature_header_v4.html">Header v4</a></li>
