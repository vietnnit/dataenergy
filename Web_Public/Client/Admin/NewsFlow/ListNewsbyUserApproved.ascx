<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListNewsbyUserApproved.ascx.cs" Inherits="Client_Admin_ListNewsbyUserApproved" %>
...
<header id="topbar">
    ...
    <div class="topbar-right">
        ...
        <div class="topbar-icon ml15 ib va-m" id="panelcomment" runat="server" visible="false">
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            OnRowDataBound="grvNewsGroup_RowDataBound" EmptyDataText="Không tìm thấy bản ghi nào">
                ...
                <Columns>
                   ...
                   <asp:TemplateField HeaderText="Duyệt">
                        ...
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_approved" runat="server" CommandName="_approved" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Duyệt tin">
                     ...
                     <asp:TemplateField HeaderText="YC Duyệt">
                        ...
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_approvedcomment" runat="server" CommandName="_approvedcomment" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Danh sách Comment">
            ...
            <div class="form-group ">
                ...
                <asp:Button runat="server" ID="Button5" CssClass="btn btn-sm btn-primary mr10" Text="Xóa tin" OnClick="btn_delall_Click" />
