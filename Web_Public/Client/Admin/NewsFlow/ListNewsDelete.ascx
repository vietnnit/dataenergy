<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListNewsDelete.ascx.cs" Inherits="Client_Admin_ListNewsDelete" %>
...
<header id="topbar">
    ...
    <div class="topbar-right">
        ...
        <div class="topbar-icon ml15 ib va-m">
         ...
         <div class="topbar-icon ml15 ib va-m">
            <asp:LinkButton ID="btn_restore" runat="server" OnClick='btn_restore_Click' CssClass="pl5" title="Phê duyệt"> 
                <i class="fa fa-check fs22 text-primary"></i><br /><span class="fs11">Phục hồi</span>
            </asp:LinkButton>
        </div> 
        ...
        <div class="panel-body">
            ...
            OnRowDataBound="grvNewsGroup_RowDataBound" EmptyDataText="Không tìm thấy bản ghi nào">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Phục hồi">
                        <ItemStyle CssClass="text-center" />
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_restore" runat="server" CommandName="_restore" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Phục hồi">
                            <span class="glyphicons glyphicons-unshare fs18 text-alert" ></span>
                            </asp:LinkButton>
            ...
            <div class="form-group ">
                ...
                <asp:Button runat="server" ID="btn_restore1" CssClass="btn btn-sm btn-primary mr10" Text="Phục hồi" OnClick="btn_restore_Click" />
                <asp:Button runat="server" ID="btn_delall1" CssClass="btn btn-sm btn-primary mr10" Text="Xóa tất cả" OnClick="btn_delall_Click" />
