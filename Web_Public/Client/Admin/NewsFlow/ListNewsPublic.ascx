<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListNewsPublic.ascx.cs" Inherits="Client_Admin_ListNewsPublic" %>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Xem">
                        ...
                        <ItemTemplate>
                            ...
                            <span class="glyphicons glyphicons-display fs18 text-alert" ></span>
                            </asp:LinkButton>
                   
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Hủy duyệt">
                        <ItemStyle CssClass="text-center" />
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_approved" runat="server" CommandName="_approved" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Hủy duyệt">
                            <span class="glyphicons glyphicons-down_arrow fs18 text-danger" ></span>
                            </asp:LinkButton>
                   
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:TemplateField HeaderText="Khóa bài">
                        <ItemStyle CssClass="text-center" />
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_lock" runat="server" CommandName="_lock" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Khóa bài">
                            <span class="glyphicons glyphicons-lock fs18 text-danger" ></span>
                            </asp:LinkButton>
                     ...
                     <asp:TemplateField HeaderText="YC Duyệt">
                        ...
                        <HeaderStyle CssClass="text-center" Width="30px" />
                        <ItemTemplate>
                             <asp:LinkButton ID="btn_approvedcomment" runat="server" CommandName="_approvedcomment" CommandArgument='<%# Eval("NewsGroupID") %>' ToolTip="Yêu cầu duyệt">
