<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditNewsbyUser.ascx.cs"
    Inherits="Client_Admin_EditNewsbyUser" %>
...
<header id="topbar">
    ...
    <div class="topbar-right">
        ...
        <div class="topbar-icon ml15 ib va-m">
            <asp:LinkButton ID="btn_listnews" runat="server" OnClick='btn_list_click' CssClass="pl5" title="Comment"> 
            ...
            <hr />
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10 col-md-10">
                            ...
                            <div class="checkbox-custom pt5">
                                <asp:CheckBox ID="rdbComment" runat="server" Text="Cho phép đăng nhận xét/Chia sẻ"/>
                            </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-2 control-label" for="inputSmall">Ngày đăng</label>
                    <div class="col-lg-4">
                ...
                <div class="form-group">
                    <label class="col-lg-2 control-label" for="inputSmall">Trang thái đăng</label>
                    <div class="col-lg-10">
                            <div class="checkbox-custom pt5">
                                <asp:CheckBox ID="rdbStatus" runat="server" Text="Đã đăng"/>
                            </div>
                    </div>
                </div>

                <div class="form-group">
                    <label class="col-lg-2 control-label" for="inputSmall">Trạng thái duyệt bài</label>
                    <div class="col-lg-10">
                            <div class="checkbox-custom pt5">
                                <asp:CheckBox ID="rdbApproval" runat="server" Text="Đã duyệt bài"/>
                            </div>
                    </div>
                </div>
...
<script language="javascript" type="text/javascript">
    function Confirmation() {
        ...
        var value = confirm("Nội dung mô tả tin vượt quá giới hạn 60 từ! Nhập lại???");

        document.getElementById('hnd').value = value;
    }
</script>
<asp:HiddenField runat="server" Value="" ID="hnd" />
