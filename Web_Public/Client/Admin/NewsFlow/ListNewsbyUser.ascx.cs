...
using ETO;
using BSO;
public partial class Client_Admin_ListNewsbyUser : System.Web.UI.UserControl
{
    ...
    private void ViewNewsGroup(int group)
    {
        ...
        if (!Session["Admin_UserName"].Equals("administrator"))
        {
            ...
            if (strCate != "")
                table = newsGroupBSO.GetNewsGroupPagingbyUser(Language.language, group, strCate, _page, Session["Admin_UserName"].ToString());
        }
        else
        {
    ...
    protected void ddlCateNewsGroupSearch_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (!Session["Admin_UserName"].Equals("administrator"))
        {
            ...
            if (strCate != "")
                table = newsGroupBSO.GetNewsGroupPagingbyUser(Language.language, Convert.ToInt32(ddlCateNewsGroup.SelectedValue), strCate, _page, Session["Admin_UserName"].ToString());
        }
        else
        {
