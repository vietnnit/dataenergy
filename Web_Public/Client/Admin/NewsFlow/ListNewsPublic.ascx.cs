...
using ETO;
using BSO;
public partial class Client_Admin_ListNewsPublic : System.Web.UI.UserControl
{
    ...
    private void ViewNewsGroup(int group)
    {
        ...
        if (!Session["Admin_UserName"].Equals("administrator"))
        {
            ...
            if (strCate != "")
                table = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, group, strCate, _page, 1, 1);
        }
        else
        {
            table = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, group, "", _page, 1, 1);
        }
    ...
    protected void ddlCateNewsGroupSearch_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (!Session["Admin_UserName"].Equals("administrator"))
        {
            ...
            if (strCate != "")
                table = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, Convert.ToInt32(ddlCateNewsGroup.SelectedValue), strCate, _page, 1, 1);
        }
        else
        {
            table = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, Convert.ToInt32(ddlCateNewsGroup.SelectedValue), "", _page, 1, 1);
        }
    ...
    protected void ddlCateNewsSearch_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (ddlCateNewsSearch.SelectedValue == "0")
        {
            ...
            table = newsGroupBSO.GetNewsGroupPagingApproved(Language.language, Convert.ToInt32(ddlCateNewsGroup.SelectedValue), Convert.ToInt32(ddlCateNewsSearch.SelectedValue), _page, 1, 1);
