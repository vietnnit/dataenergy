<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditCateNewsMove.ascx.cs"
    Inherits="Admin_Controls_EditCateNewsMove" %>
<header id="topbar">
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Lựa chọn chuyên mục</label>
                <div class="col-lg-6">
                     
                     <asp:DropDownList ID="ddlCateNewsGroup" runat="server" AppendDataBoundItems="True" 
                         CssClass="form-control input-sm" AutoPostBack="True" OnSelectedIndexChanged="ddlCateNewsGroup_SelectedIndexChanged">
             ...
             <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Lựa chọn tiểu mục</label>
                <div class="col-lg-6">
            ...
            <div class="form-group">
                ...
                <asp:Button runat="server" ID="btn_add2" CssClass="btn btn-sm btn-primary mr10" Text="Lưu & thêm mới" OnClick="btn_add_Click_more" Visible="false" />
