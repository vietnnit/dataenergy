<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CreateProvince.ascx.cs"
    Inherits="Client_Admin_List_CreateProvince" %>
<header id="topbar">
    ...
    <div class="topbar-right">
         ...
         <div class="topbar-icon ml15 ib va-m">
             <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/ListProvince/Default.aspx" CssClass="pl5" title="Danh mục"> 
                <i class="fa fa-list-alt fs22 text-primary"></i><br /><span class="fs11">Danh mục</span>
            </asp:HyperLink>
        </div>  
        <div class="topbar-icon ml15 ib va-m">
             <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Admin/CreateProvince/Default.aspx" CssClass="pl5" title="Tạo mới"> 
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Tên Tỉnh/TP</label>
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Mã Tỉnh/TP</label>
                
                <div class="col-lg-6">
                    <asp:TextBox ID="txtProvinceCode" runat="server" CssClass="form-control input-sm" placeholder="Nhập mã Tỉnh/TP"></asp:TextBox>
                </div>
            </div>
            <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Vùng/miền</label>                
                <div class="col-lg-6">
                    <asp:DropDownList ID="ddlParent" runat="server" CssClass="form-control input-sm" >
                    <asp:ListItem Text="---Chọn vùng miền---"  Value=""></asp:ListItem>
                    <asp:ListItem Text="ĐỒNG BẰNG SÔNG HỒNG"  Value="2"></asp:ListItem>
                    <asp:ListItem Text="TRUNG DU VÀ MIỀN NÚI PHÍA BẮC"  Value="3"></asp:ListItem>
                    <asp:ListItem Text="BẮC TRUNG BỘ VÀ DUYÊN HẢI MIỀN TRUNG"  Value="4"></asp:ListItem>
                    <asp:ListItem Text="ĐÔNG NAM BỘ"  Value="5"></asp:ListItem>
                    <asp:ListItem Text="ĐỒNG BẰNG SÔNG CỬU LONG"  Value="6"></asp:ListItem>
                    </asp:DropDownList>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Admin/ListProvince/Default.aspx" CssClass="btn btn-sm btn-system mr10" Text="Danh mục" />
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Admin/CreateProvince/Default.aspx" CssClass="btn btn-sm btn-system mr10" Text="Thêm mới" />
