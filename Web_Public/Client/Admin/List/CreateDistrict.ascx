<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CreateDistrict.ascx.cs" Inherits="Client_Admin_DataEnergy_CreateDEArea" %>
<header id="topbar">
    ...
    <div class="topbar-right">
         ...
         <div class="topbar-icon ml15 ib va-m">
             <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/ListDistrict/Default.aspx" CssClass="pl5" title="Danh mục"> 
                <i class="fa fa-list-alt fs22 text-primary"></i><br /><span class="fs11">Danh mục</span>
            </asp:HyperLink>
        </div>  
        <div class="topbar-icon ml15 ib va-m">
             <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="~/Admin/CreateDistrict/Default.aspx" CssClass="pl5" title="Tạo mới"> 
        ...
        <div class="panel-body">
            ...
            <asp:Literal ID="error" runat="server"></asp:Literal>            
             <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Tên Quận/Huyện</label>
            ...
            <div class="form-group">
                <label class="col-lg-2 control-label pt5" for="inputSmall">Mã Quận/Huyện</label>
            ...
            <div class="form-group">
                ...
                <asp:HyperLink ID="HyperLink7" runat="server" NavigateUrl="~/Admin/ListDistrict/Default.aspx" CssClass="btn btn-sm btn-system mr10" Text="Danh mục" />
                <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Admin/CreateDistrict/Default.aspx" CssClass="btn btn-sm btn-system mr10" Text="Thêm mới" />
