<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWidgetPageLayoutbyPage.ascx.cs"
    Inherits="Admin_Controls_EditWidgetPageLayoutbyPage" %>
...
<header id="topbar">
    ...
    <div class="topbar-right">
          ...
          <div class="topbar-icon ml15 ib va-m">
            <asp:LinkButton ID="LinkButton2" runat="server" OnClick='btn_create_Click' CssClass="pl5" title="Thêm mới" ValidationGroup="Create"> 
                <i class="fa fa-edit fs22 text-primary"></i><br /><span class="fs11">Thêm mới</span>
            </asp:LinkButton>
        </div> 

         <div class="topbar-icon ml15 ib va-m">
            <a href="/Admin/CopyWidgetPage/Default.aspx" class="pl5" title="Sao chép" target="_blank"> 
                <i class="fa fa-copy fs22 text-alert"></i><br /><span class="fs11">Sao chép</span>
            </a>
        </div>
            ...
            <div class="form-horizontal">
                ...
                <div class="row">
                 ...
                 <div class="row">
                   <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 col-sm-4 control-label pt5" for="inputSmall">Chọn kiểu Widget</label>
                            <div class="col-lg-8 col-md-8 col-sm-8">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                       ...
                       <div class="col-lg-6 col-md-6 col-sm-6 text-left">
                        ...
                        <asp:Button runat="server" ID="Button3" CssClass="btn btn-sm btn-primary mr10" Text="Thêm mới" OnClick="btn_create_Click"  ValidationGroup="Create"/>
                        <asp:Button runat="server" ID="Button1" CssClass="btn btn-sm btn-system mr10" Text="Sắp xếp" OnClick="btn_Order_Click"  ValidationGroup="sort"/>
...
<asp:HiddenField ID="hddPageLayout" runat="server" />