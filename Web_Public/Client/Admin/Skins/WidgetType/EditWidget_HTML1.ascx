<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWidget_HTML1.ascx.cs"
    Inherits="Admin_Controls_EditWidget_HTML1" %>
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="form-group">
                            <label class="col-lg-2 col-md-2 col-sm-2 control-label pt5" for="inputSmall">Info</label>
...
<asp:HiddenField ID="hddRegion" runat="server" />
