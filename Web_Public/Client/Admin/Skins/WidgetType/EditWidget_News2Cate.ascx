<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWidget_News2Cate.ascx.cs"
    Inherits="Admin_Controls_EditTVWidget_News2Cate" %>
<header id="topbar">
                 ...
                 <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 col-sm-4 control-label pt5" for="inputSmall">Chọn chuyên mục</label>
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                <asp:ListBox ID="lboGroupCate2" runat="server" Height="200px" 
                                onselectedindexchanged="lboGroupCate2_SelectedIndexChanged" AutoPostBack="true"
                                CssClass="form-control input-sm" ValidationGroup="update">
                                </asp:ListBox>
                            </div>
                        </div>
                     ...
                     <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group">
                                ...
                                <asp:ListBox ID="lboCateNews2" runat="server" Height="200px" 
                                CssClass="form-control input-sm" ValidationGroup="update">
                                </asp:ListBox>
