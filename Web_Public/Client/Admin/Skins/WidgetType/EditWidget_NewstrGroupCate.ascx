<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWidget_NewstrGroupCate.ascx.cs"
    Inherits="Admin_Controls_EditTVWidget_NewstrGroupCate" %>
<header id="topbar">
                 ...
                 <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8 col-md-8 col-sm-8">
                                 <div class="checkbox-custom pt5">
                                        <asp:CheckBoxList ID="chkCateNews" runat="server" ValidationGroup="update">
                                        </asp:CheckBoxList>
                                    </div>
                            </div>
                        </div>
