<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditWidget_MenuLinks.ascx.cs"
    Inherits="Admin_Controls_EditTVWidget_MenuLinks" %>
<header id="topbar">
            ...
            <div class="form-horizontal">
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group">
                            <label class="col-lg-4 col-md-4 col-sm-4 control-label pt5" for="inputSmall">Chọn Link/Banner</label>
                            <div class="col-lg-8 col-md-8 col-sm-8">
