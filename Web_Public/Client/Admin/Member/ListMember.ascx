<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ListMember.ascx.cs" Inherits="Admin_Member_ListMember" %>
            ...
            <div class="form-horizontal">
                ...
                <div class="row">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-lg-4">
                                 <asp:DropDownList ID="ddlOrg" runat="server" AppendDataBoundItems="True" AutoPostBack="true"
    ...
    <div class="panel">
        <div class="panel-body">
            ...
            <div class="form-group ">
                ...
                <asp:HyperLink ID="HyperLink2" runat="server" CssClass="btn btn-sm btn-primary" NavigateUrl="~/Admin/editMember/Default.aspx" Text="Thêm mới" />
