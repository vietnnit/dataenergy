<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SCTBaoCaoChoPheDuyet.ascx.cs" Inherits="Client_Admin_DataEngery_SCTBaoCaoChoPheDuyet" %>
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            <li class="crumb-active">
                <a href="javascript:void();"> <asp:Literal ID="litModules" runat="server" Text="Báo cáo chờ phê duyệt"></asp:Literal></a>
            </li>
            <li class="crumb-icon">
   ...
   <div class="row mb10">
        ...
        LastString="Trang cuối" NextString="Tiếp" PrevString="Quay lại" />
                    ...
                    <div class="form-horizontal">                                                               
                        ...
                        <a class="fa fa-info-circle" href='<%#ResolveUrl("~") %>Admin/SCTBaoCaoChoPheDuyetView/<%#Eval("AutoID") %>/Default.aspx'></a>
