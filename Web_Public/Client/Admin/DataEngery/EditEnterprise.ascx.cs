...
public partial class Client_Admin_EditEnterprise : System.Web.UI.UserControl
{
    ...
    void BindProvince()
    {
        ...
        org = new OrganizationService().FindByKey(m_UserValidation.OrgId);
        if (org != null)
        {
            var lstFilter = list.Where(m => m.Id == org.ProvinceId).ToList();
            ddlProvince.DataSource = lstFilter;
            ddlProvince.DataTextField = "ProvinceName";
            ddlProvince.DataValueField = "Id";
            ddlProvince.DataBind();
        }
        else ddlProvince.Items.Insert(0, new ListItem("---Chọn---", ""));
    }
