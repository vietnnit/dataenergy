<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditEnterpriseForOrg.ascx.cs"
    Inherits="Client_Admin_EditEnterpriseForOrg" %>
...
<header id="topbar">
    ...
    <div class="topbar-right">
         ...
         <div class="topbar-icon ml15 ib va-m">
             <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Admin/ListEnterpriseForOrg/Default.aspx" CssClass="pl5" title="Danh sách DN/cơ sở"> 
                        ...
                        <div class="col-lg-8">
                         ...
                         <hr class="hr-danger" />                          
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <label class="col-lg-2 control-label pt5" for="inputSmall">Cơ quan quản lý<span class="text-danger"> *</span></label>                
                                <div class="col-lg-10">
                                    <asp:DropDownList ID="ddlOrg" runat="server" CssClass="form-control input-sm"  ValidationGroup="vgInfo">
                                        </asp:DropDownList>    
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="ddlOrg" Display="Dynamic"  ValidationGroup="vgInfo"
                                        ErrorMessage="RequiredFieldValidator"><span class="append-icon right text-danger"><i class="fa fa-exclamation-triangle"></i></span></asp:RequiredFieldValidator>
                                </div>
                            </div>                    
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">                     
                                        <asp:DropDownList ID="ddlSubArea" runat="server" AppendDataBoundItems="True"  ValidationGroup="vgInfo" CssClass="form-control input-sm">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator6"  ValidationGroup="vgInfo" runat="server" ControlToValidate="ddlArea" Display="Dynamic"
                                        ErrorMessage="RequiredFieldValidator"><span class="append-icon right text-danger"><i class="fa fa-exclamation-triangle"></i></span></asp:RequiredFieldValidator>
                                </div>
                            </div>   
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-4">                                    
                                    <asp:TextBox ID="txtMST"  ValidationGroup="vgInfo" runat="server" CssClass="form-control input-sm" placeholder="Nhập MST"></asp:TextBox>
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="txtMST" Display="Dynamic"  ValidationGroup="vgInfo"
                                        ErrorMessage="RequiredFieldValidator"><span class="append-icon right text-danger"><i class="fa fa-exclamation-triangle"></i></span></asp:RequiredFieldValidator>
                            ...
                            <b>TÌNH TRẠNG DN/CƠ SỞ</b>
                            <hr class="hr-danger" />  
                                        <asp:Literal ID="ltrImportantInfo" runat="server"></asp:Literal>
                            <div class="form-group" runat="server" id="divImportantYear">
                  ...
                  <table class="table table-bordered table-hover mbn" width="100%">
                                <tr class="primary fs12">
                                   ...
                                   <th style="width:10%" class="text-center">Năm</th>                         
                                    <th>Năng lượng tiêu thụ năm (TOE)</th>          
                                    <th>Năng lượng dự kiến tiêu thụ năm (TOE)</th>          
                                    <th>DN trọng điểm</th> 
                                 ...
                                 <asp:Repeater ID="rptImportantYear" runat="server">
                                                    <ItemTemplate>
                                                        <tr>                                   
                                                            <td class="text-center"><%#Container.ItemIndex+1  %></td>   
                                                             <td class="text-right"><a href='<%#ResolveUrl("~") %>Admin/ViewReportDetail/<%#Eval("Id") %>/Default.aspx'><%#Eval("Year")%></a></td>
                                                              <td class="text-right"><%#Tool.ConvertDecimalToString(Eval("No_TOE"),2)%></td>
                                                              <td class="text-right"><%#Tool.ConvertDecimalToString(Eval("NoTOE_Plan"),2)%></td>
                                                              <td class="text-center"><%#Eval("IsKey") != null && Convert.ToBoolean(Eval("IsKey"))?"Có":"Không"%></td>
                                            ...
                                            <span class="glyphicons glyphicons-edit fs18" ></span>
                                             ...
                                             <asp:LinkButton ID="btn_delete_importantyear" OnClick="btn_delete_importantyear_Click" OnClientClick="return confirm('Bạn có chắc chắn muốn xóa thông tin này không?');" runat="server"  CommandArgument='<%# Eval("Id") %>' ToolTip="Xóa bỏ">
                                            <span class="glyphicons glyphicons-remove_2 fs18 text-danger" ></span>
                                            </asp:LinkButton>                                                     
                                                             </td>
                                  </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="inputSmall">Năng lượng tiêu thụ(TOE)<span class="text-danger"> *</span></label>
                        <div class="col-lg-3">                                    
                            <asp:TextBox ID="txtNoTOE" runat="server" CssClass="form-control input-sm" placeholder="Địa chỉ" ValidationGroup="valTOE"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="rexNoTOE" runat="server" ControlToValidate="txtNoTOE"
                                CssClass="text-danger" ValidationGroup="valTOE" Text="Năng lượng tiêu thụ chỉ nhập số"
                                ValidationExpression="^[0-9]{1,18}(\,[0-9]{1,2})?$" Display="Dynamic"></asp:RegularExpressionValidator>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-3 control-label">
                            Năm trọng điểm:</label>
                        <div class="col-lg-3">
                            <asp:RadioButtonList ID="rblKeu" runat="server" RepeatDirection="Horizontal">
            ...
            <div class="modal-footer">
                <asp:Button ID="btnAddImportantYear" runat="server" Text="Lưu lại" OnClick="btnAddImportantYear_Click"
                    CssClass="btn btn-sm btn-primary mr10" ValidationGroup="valTOE" AutoPostback="false"></asp:Button>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <asp:TextBox ID="txtAdminName1" runat="server" CssClass="form-control input-sm" placeholder="Nhập tên tài khoản">
                            </asp:TextBox>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">
                    Reset mật khẩu doanh nghiệp</h4>
            </div>
            <div class="modal-body">
                <div class="form-horizontal">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <asp:TextBox ID="txtAdminPass" runat="server" CssClass="form-control input-sm" placeholder="Nhập mật khẩu"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            ...
                            <asp:TextBox ID="txtAdminConfirmPass" runat="server" CssClass="form-control input-sm"
                                placeholder="Nhập lại mật khẩu" ValidationGroup="vgPass">
                            </asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <asp:Button ID="btnSavePass" runat="server" ValidationGroup="vgPass" Visible="true"
                    Text="Lưu lại" OnClick="btnSavePass_Click" CssClass="btn btn-sm btn-primary mr10"
                    AutoPostback="false"></asp:Button>
                <button type="button" class="btn btn-sm btn-default" data-dismiss="modal">
                    Đóng</button>
            </div>
