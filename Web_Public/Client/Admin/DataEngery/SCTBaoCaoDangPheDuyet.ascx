<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SCTBaoCaoDangPheDuyet.ascx.cs" Inherits="Client_Admin_DataEngery_SCTBaoCaoDangPheDuyet" %>
    ...
    <div class="topbar-left">
        <ol class="breadcrumb">
            <li class="crumb-active">
                <a href="javascript:void();"> <asp:Literal ID="litModules" runat="server" Text="Báo cáo đang phê duyệt"></asp:Literal></a>
            </li>
            <li class="crumb-icon">
   ...
   <div class="row mb10">
        ...
        LastString="Trang cuối" NextString="Tiếp" PrevString="Quay lại" />
                    ...
                    <div class="form-horizontal">                                                               
                                    ...
                                    <table class="table table-bordered table-hover mbn" width="100%">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><a href='<%#ResolveUrl("~") %>Admin/SCTBaoCaoDangPheDuyetView/<%#Eval("AutoID") %>/Default.aspx'><%#Eval("Title") %></a></td>                                                        
                                                <td><%#Eval("Address") %></td>
                        ...
                        <a class="fa fa-info-circle" href='<%#ResolveUrl("~") %>Admin/SCTBaoCaoDangPheDuyetView/<%#Eval("AutoID") %>/Default.aspx'></a>
