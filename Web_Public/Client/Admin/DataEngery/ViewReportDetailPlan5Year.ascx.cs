...
public partial class Client_Admin_DataEngery_ViewReportDetailPlan5Year : System.Web.UI.UserControl
{
    int ReportId
    {
        get
    ...
    private void BindProductCapacity()
    {
        ...
        var rpInfo = rp.DE_ReportFuel.FirstOrDefault(o => o.Id == ReportId);
        ...
        var oldData = rp.DE_ReportFuel.FirstOrDefault(o => o.Year == ReportYear && o.EnterpriseId == rpInfo.EnterpriseId && o.IsFiveYear == false && o.ReportType == ReportKey.PLAN);
    ...
    DataTable GetKQThucHienKeHoach()
    {
        ...
        var Solution5Year = (from a in rp.DE_GiaiPhap
                             ...
                             where c.EnterpriseId == rpInfo.EnterpriseId && c.ReportType == ReportKey.PLAN && b.IsPlan == true
