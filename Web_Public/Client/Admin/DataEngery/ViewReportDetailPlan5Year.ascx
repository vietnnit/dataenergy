<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewReportDetailPlan5Year.ascx.cs" Inherits="Client_Admin_DataEngery_ViewReportDetailPlan5Year" %>
        ...
        <div class="tab-block mb25">
            <div class=" tab-content">
                <div class="panel" style="width: 100%" for="inputSmall">
                    ...
                    <div style="float: right">
                        <div class="col-lg-12 text-left">
                            ...
                            <asp:LinkButton  runat="server" ID="btnExport5Word1" CssClass="btn btn-sm btn-success mr10"
                ...
                <div class="">
                    <div id="EnterpriseInfo" class="collapse">
                        <table class="table table-bordered table-hover mbn" width="100%">
                            <tr>
                                <td style="width: 20%">
                                    <label>
                                        Lĩnh vực</label></td>
                                <td style="width: 30%">
                                    <asp:Literal ID="ltAreaName" runat="server"></asp:Literal></td>
                                <td style="width: 20%">
                                    <label>
                                        Phân ngành</label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label>Tỉnh/TP</label></td>
                                <td>
                                    <asp:Literal ID="ltProvinceName" runat="server"></asp:Literal></td>
                                <td>
                                    <label>Quận/Huyện</label></td>
                                <td>
                                    <asp:Literal ID="ltDistrictName" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Mã số thuế</label></td>
                                <td>
                                    <asp:Literal ID="ltTaxNo" runat="server"></asp:Literal></td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label>Số điện thoại</label></td>
                                <td>
                                    <asp:Literal ID="ltPhoneNumber" runat="server"></asp:Literal></td>
                                <td>
                                    <label>Fax</label></td>
                                <td>
                                    <asp:Literal ID="ltFaxNo" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Chịu trách nhiệm</label></td>
                                <td>
                                    <asp:Literal ID="ltResponsible" runat="server"></asp:Literal></td>
                                <td>
                                    <label>Chủ sở hữu</label></td>
                                <td>
                                    <asp:Literal ID="ltOwner" runat="server"></asp:Literal></td>
                            </tr>
                        </table>
                        <table class="table table-bordered table-hover mbn" width="100%">
                            <tr>
                                <td style="width: 20%">
                                    <label>Công ty mẹ</label></td>
                                <td colspan="3">
                                    <asp:Literal ID="ltParentName" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
                                <td style="width: 20%">
                                    <label>Tỉnh/TP</label></td>
                                <td style="width: 30%">
                                    <asp:Literal ID="ltProvinceParent" runat="server"></asp:Literal></td>
                                <td style="width: 20%">
                                    <label>
                                        Quyện/Huyện</label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label>Địa chỉ</label></td>
                                <td colspan="3">
                                    <asp:Literal ID="ltAddressParent" runat="server"></asp:Literal></td>
                            </tr>
                            <tr>
                                <td>
                                    <label>Số điện thoại</label></td>
                                <td>
                                    <asp:Literal ID="ltPhoneParent" runat="server"></asp:Literal></td>
                                <td>
                                    <label>
                                        Fax</label>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <label>Email</label></td>
                                <td colspan="3">
                                    <asp:Literal ID="ltEmailParent" runat="server"></asp:Literal></td>
                            </tr>
                        </table>
                    </div>
                </div>
                ...
                <div id="tabReport">
                    ...
                    <div id="tabChuyen">
                        <div class="active" style="border-top: 0">
                            <div id="tabProduct">
                                <uc1:ViewProductYear ID="ucProduct" runat="server" Visible="false" />
                                <div class="col-lg-12">
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="control-label pt5" style="width: 100%; text-align: left">
                                                <b>
                                                    <asp:Literal ID="ltDataCurrentTitle" runat="server" Text="Mức nhiên liệu tiêu thụ thực tế"></asp:Literal></b>
                                            </div>
                                            <table class="table table-bordered table-hover mbn" width="100%">
                                                <tr class="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-12">
                                            <div class="control-label pt5" style="width: 100%; text-align: left;">
                                                <b>
                                                    <asp:Literal ID="ltDataNextYearTitle" runat="server" Text="Kế hoạch tiêu thụ nhiên liệu"></asp:Literal></b>
                                            </div>
                                            <table class="table table-bordered table-hover mbn" width="100%">
                                                <tr class="">
                                                    <th style="width: 5%">STT
                            ...
                            <div id="tabPlan5Year">
                                <uc1:ViewPlan5Year ID="ucViewPlan5Year" runat="server" Visible="true" />
                                <div class="margin-bottom-10">
                                    <label class="control-label">
