...
<div class="form-horizontal">
    <div class="form-group" style="margin-bottom: 0;">
        ...
        <div class="col-lg-12">
            <div class="text-left">
                <asp:Literal ID="ltNextPeriod" runat="server" Text="Kế hoạch thực hiện"></asp:Literal></div>
            <div class="margin-bottom-10">
                <div class="">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br />
                                        Thành tiền:
                                        <%# (Eval("ThanhTien") != DBNull.Value && Eval("ThanhTien").ToString()!="") ? Eval("ThanhTien")+" (tr.đồng)":""%>
                                        <br />
                                        Lợi ích khác:
                                        <%# Eval("LoiIchKhac")%>
                                    </td>
