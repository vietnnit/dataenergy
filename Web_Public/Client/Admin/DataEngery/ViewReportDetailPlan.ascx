<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewReportDetailPlan.ascx.cs"
    Inherits="Client_Admin_DataEnergy_ViewReportDetailPlan" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs tabs-border" id="Reporttabs">
                            ...
                            <li><a rel="tabPlan5Year" href="#" class="" id="xxxx_noview01" style="display:none;">Giải pháp TKNL 5 năm</a></li> 
                        </ul>
                    </div>
                </div>
                <div id="tabChuyen">
