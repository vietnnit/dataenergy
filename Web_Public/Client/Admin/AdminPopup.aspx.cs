...
using ETO;
using BSO;
public partial class AdminPopup : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //            Response.Redirect("~/Client/Admin/Login.aspx");
            ...
            if (!string.IsNullOrEmpty(Request["dll"]))
            {
                if (CheckExit(Request["dll"].ToString()))
                {
                    ...
                    if (levelAdmin == true)
                    {
                        ...
                        PlaceHolder1.Controls.Add(LoadControl(ResolveUrl("~/") + "Client/Admin/" + _module.ModulesDir + "/" + _module.ModulesUrl + ".ascx"));
                    }
                    else
                        if (Request["dll"].Equals("login"))
                            // PlaceHolder1.Controls.Add(LoadControl("Client/Admin/Login.ascx"));
