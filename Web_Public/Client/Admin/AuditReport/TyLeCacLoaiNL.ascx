<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TyLeCacLoaiNL.ascx.cs"
    Inherits="Client_Admin_Audit_TyLeCacLoaiNL" %>
                ...
                <table class="table table-bordered table-hover mb10" width="100%">
                    <thead>
                        <tr class="text-center">
                            ...
                            <asp:Literal ID="ltHeaderFuel" runat="server"></asp:Literal>                                                              
