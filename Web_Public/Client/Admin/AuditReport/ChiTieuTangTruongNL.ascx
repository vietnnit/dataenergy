<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChiTieuTangTruongNL.ascx.cs"
    Inherits="Client_Admin_Audit_ChiTieuTangTruongNL" %>
                    ...
                    <asp:Repeater ID="rptAuditReport" runat="server" OnItemDataBound="rptAuditReport_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-right">
                                    <asp:Literal ID="ltNoTOE" runat="server"></asp:Literal>
                                </td>
                                <td class="text-right"><asp:Literal ID="ltLevelCO2" runat="server"></asp:Literal></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
