...
public partial class Client_Admin_Audit_ConfirmAuditReportList : System.Web.UI.UserControl
{
    ...
    private void BindData()
    {
        ...
        if (memVal.OrgId > 0)
        {
            ...
            DataTable list = new AuditReportService().FindList(AreaId, 0, memVal.OrgId, 0, 0, DistrictId, Convert.ToInt32(AuditReportStatus.CONFIRMED), AuditYear, txtKeyword.Text.Trim(), paging);
