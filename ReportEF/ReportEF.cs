namespace ReportEF
{
    ...
    public partial class ReportEF : DbContext
    {
        public ReportEF()
            : base("name=ReportEF")
        {
        ...
        public virtual DbSet<tblHitCounter> tblHitCounters { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<tblHitCounter>()
                .Property(e => e.Name)
                .IsUnicode(false);
