...
namespace ePower.DE.Domain
{
    public class UsingElectrictBO : BaseEntity
    {
        ...
        public UsingElectrictBO(UsingElectrict usingelectrictDTO)
        {
            ...
            this.CongSuatBan = usingelectrictDTO.CongSuatBan;
            this.SanLuongBan = usingelectrictDTO.SanLuongBan;
        }
        #endregion
        ...
        [FieldName("CongSuatBan", FieldAccessMode.ReadWrite, FieldType.String)]
        public decimal CongSuatBan
        {
            get { return _CongSuatBan; }
            set { _CongSuatBan = value; SetDirty("CongSuatBan"); }
        }

        [FieldName("SanLuongBan", FieldAccessMode.ReadWrite, FieldType.String)]
        public decimal SanLuongBan
        {
            get { return _SanLuongBan; }
            set { _SanLuongBan = value; SetDirty("SanLuongBan"); }
        }
        #endregion
